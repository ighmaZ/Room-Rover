    ...
    <div className="text-center mt-20">
      <span className="content__container block text-5xl ">
        <ul className="content__container__list">
          ...
          <li className="content__container__list__item xl:pl-3">
            Design Your Room from <span className="text-gradient">Sketch</span>{" "}
            to Reality
          </li>
          <li className="content__container__list__item xl:pl-3">
          ...
          <li className="content__container__list__item xl:pl-3">
            <span className="text-gradient">Easy </span>Interior Design, Room by
            Room.
          </li>
          <li className="content__container__list__item xl:pl-3">
          ...
          <li className="content__container__list__item xl:pl-3">
            The <span className="text-gradient">Best</span> AI interior Designer
            ever made
          </li>
        </ul>
      </span>
